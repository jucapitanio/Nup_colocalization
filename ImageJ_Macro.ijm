...
function cell_images(input, output, filename) {
  ...
  */
  ...
  saveAs("Tiff", output + "RFP_" + filename + ".tif");
  run("Z Project...", "projection=[Sum Slices]");
  selectWindow("RFP_" + filename + ".tif");
  close();
  selectWindow(filename + " - C=1");
  saveAs("Tiff", output + "GFP_" + filename + ".tif");
  run("Z Project...", "projection=[Sum Slices]");
  selectWindow("GFP_" + filename + ".tif");
  close();
...
input = "C:\\Users\\Diego\\Documents\\MATLAB\\20160301-Bip\\ImagesOriginal\\";
output = "C:\\Users\\Diego\\Documents\\MATLAB\\20160301-Bip\\rootCell\\ImageData\\";
